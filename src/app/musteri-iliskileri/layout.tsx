...
export default function MusteriIliskileriLayout({
  children,
}: {
  ...
  const links = [
    ...
    { name: 'Kargo ve Teslimat', path: '/musteri-iliskileri/kargo' },
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Başlık */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Müşteri İlişkileri</h1>
          <p className="text-gray-500 mt-2">Bize dair merak ettiğiniz her şey ve politikalarımız.</p>
        </div>
