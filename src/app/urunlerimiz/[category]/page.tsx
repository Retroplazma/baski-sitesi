...
export default async function CategoryPage({ params }: { params: Promise<{ category: string }> }) {
    ...
    return (
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
          Yeni Ürünlerimiz <span className="text-2xl">✨</span>
        </h2>
  ...
  if (categorySlug === 'hazir-sablonlar') {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] text-center bg-white border border-gray-200 rounded-lg shadow-sm">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Hazır Şablonlar Hazırlanıyor</h1>
        <p className="text-gray-500 max-w-md mx-auto">
          Tasarım yapmayı kolaylaştıracak yüzlerce profesyonel şablon çok yakında bu sayfada olacak.
        </p>
      </div>
    );
  }
